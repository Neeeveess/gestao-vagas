package br.com.jvneves.gestao_vagas.modules.candidate.controllers;
...
import br.com.jvneves.gestao_vagas.modules.candidate.entity.ApplyJobEntity;
import br.com.jvneves.gestao_vagas.modules.candidate.useCases.ApplyJobCandidateUseCase;
...
import br.com.jvneves.gestao_vagas.modules.company.entities.JobEntity;
...
public class CandidateController {
  ...
  @PostMapping("/")
  @Operation(summary = "Cadastro de candidatos", description = "Essa função é responsavel por cadastrar um candidato")
  @ApiResponses({
  ...
  @GetMapping("/job")
  @PreAuthorize("hasRole('CANDIDATE')")
  @Operation(summary = "Listagem de vagas disponivel para o candidato", description = "Essa função é responsavel por listar todas as vagas disponiveis baseada no filtro")
  ...
  @PreAuthorize("hasRole('CANDIDATE')")
  @Operation(summary = "Aplicar para uma vaga", description = "Essa função é responsavel por aplicar para uma vaga")
  @ApiResponses({ @ApiResponse(responseCode = "200", content = {
